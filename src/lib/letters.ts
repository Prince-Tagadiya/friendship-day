...
const RAW_LETTERS: Record<string, LetterContent> = {
  ...
  khushi: {
    ...
    lines: [
      ...
      { text: 'You\'re one of those people. 🤍', variant: 'highlight' },
      ...
      { text: '**Hamesha aavi j rehje... and hamesha khush rehje. 🌸🤍**', variant: 'center-bold' },
      { text: 'Thank you... for everything.', variant: 'normal', topSpacing: true },
