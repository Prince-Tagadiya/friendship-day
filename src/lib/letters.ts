...
const RAW_LETTERS: Record<string, LetterContent> = {
  ...
  khushi: {
    ...
    lines: [
      ...
      { text: 'Congrats on mastering both 2-wheeler & 4-wheeler! Tu taan ekdum pro driver bani vee aahyo! 🛵🚗💨', variant: 'highlight', topSpacing: true },
      { text: 'Roads par thoda sambhaali halaye 🛵🚗... helmet & seatbelt zaroor pehnjo! 😂', variant: 'quote' },
      ...
      { text: 'May all your dreams come true, and Bhagwan tuhinje mathan hamesha aashirwad rakhe.', variant: 'normal' },
